...
<div class="alert alert-success alert-dismissible fade show w-25" role="alert">
        <strong>Agregado!</strong> Las medidas fueron agregadas.
...
<script>
    ...
    if(code==8) {
                    ...
                    <h3>
                            ...
                            <div class="formulario__grupo" id="grupo__nombre">
                             ...
                             <div class="formulario__grupo-input">
                                <input  class="formulario__input" id='nombre' name='nombre' maxlength="25" onkeypress="return validelet(event);" >
                            ...
                            <div class="formulario__grupo" id="grupo__apellido">
                             ...
                             <div class="formulario__grupo-input">
                             <input class="formulario__input" id='apellido' name='apellido' maxlength="25"  onkeypress="return validelet(event);">
                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                             </div>
        ...
        if(isset($_POST["enviar"])){
            ...
            if ($resultado === TRUE) {
                    header('Location: enviarmedidasadmin.php?mensaje=agregado');                    
                }else{
